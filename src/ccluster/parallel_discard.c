...
//SOO DEBUG
int parallel_discard_done = 0;
pthread_mutex_t parallel_discard_mdone = PTHREAD_MUTEX_INITIALIZER;
pthread_cond_t parallel_discard_cdone = PTHREAD_COND_INITIALIZER;
